...
// Color settings
const baseHue = 240; // Base color: 0=red, 120=green, 180=cyan, 240=blue, 300=magenta
const hueRange = 10; // How much the color varies (0 = single color, 120 = wide rainbow)
const saturation = 50; // Color saturation (0 = grayscale, 100 = vivid)
const lightness = 0; // Color lightness (0 = black, 50 = normal, 100 = white)
